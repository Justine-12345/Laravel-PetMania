...
{!!  Form::hidden('role', 'new') !!}
        ...
        <td style="padding-left: 20px; padding-right: 0px"> 
            ...
            <div style="position: relative;bottom:300px ; color: #00abed; font-size: 30px; text-shadow: white 2px 2px 5px; text-align: center;font-family:">
                ...
                <br>
            <b class="hovicon effect-8" style="height: 50px; width: 50px;margin: 0px; position: relative; left: 60px; top: 15px"
            data-toggle="popover" title="Friendly Reminder" data-content="Please Register For Easy Adoption Process"
            ></b>
